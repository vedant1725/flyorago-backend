...
p = r'C:\Users\Akash\OneDrive\Documents\flyorago-backend\apps\notifications\flyorago_logo_transparent.png'
with open(p, 'rb') as f:
...
print("Successfully created final templates.py! File size:", os.path.getsize(out_path))
