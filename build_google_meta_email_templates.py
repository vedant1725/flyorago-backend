...
target_file = r'c:\Users\Akash\OneDrive\Documents\flyorago-backend\apps\notifications\email_service\templates.py'
with open(target_file, 'w', encoding='utf-8') as f:
    f.write(template_code)

print("Successfully created Google & Meta grade templates.py! File size:", os.path.getsize(target_file))
